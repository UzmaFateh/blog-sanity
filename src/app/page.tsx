...

      {
        data.map((blog, index)=>{
          return(
            ...
            <div className="p-4 md:w-full  min-h-72 ">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden shadow-md
              hover:scale-105 active:scale-100 transition-all cursor-pointer">
              <Image className="lg:h-48 md:h-full w-full object-cover object-center"
               src={blog.imageUrl}
               alt="blog"
               width={500}
               height={400}></Image>
